...
fun CleanLabeledTextField(
    ...
    BasicTextField(
        ...
        enabled = enabled,
        textStyle = textStyle.copy(fontSize = fontSize, color = Color.Black),
        keyboardOptions = KeyboardOptions(imeAction = keyboardAction, capitalization = KeyboardCapitalization.Words)
    ) { innerTextField ->
